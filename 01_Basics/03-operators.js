...
console.log(x >= y && x == y); // AND -> Both sides must be true; if even one is false, the output will be false.
console.log(x > y || y == x); // OR -> Only one condition needs to be true, and the output will always be true.
console.log(!true); // NOT -> It converts True to False and False to True.
